        ...
        <div id="mid">
            ...
            <div class="pro_price">
                <dl>
                    ...
                    <dd><table height="315" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border:#ccc 1px solid;">
                        <tbody>
                        <input type="hidden" value="${showtupian}">
                        <tr>
                            <td valign="top" align="middle" width="323" colspan="2"
                                height="30"><font
                                    color="#bb1213"><strong>${names}</strong></font></td>
                        </tr>
                        <tr>
                            <td valign="top" align="right" width="111"
                                height="28">市 场 价：</td>
                            <td valign="top" width="212" height="28"><span style="text-decoration:line-through; font-size:14px;color:#666; font-weight:bold;">￥1220000</span></td>
                        </tr>
                        <tr>
                            <td valign="top" align="right" width="111"
                                height="28">网站价格：</td>
                            <td valign="top" width="212" height="28"><span style=" font-size:14px;color:#c00; font-weight:bold;">￥${prices}</span></td>
                        </tr>
                        <tr>
                            <td valign="top" align="right" width="111"
                                height="28">规&nbsp;&nbsp;&nbsp; 格：</td>
                        ...
                        <tr>
                            ...
                            <td valign="top" width="212"
                                height="28"><input type="text" style="width:30px;margin-top: 2px"/></td>
                        </tr>
                        <tr>
                            <td align="middle" width="200"
                                height="30"><span style="font-size:20px; color:#f00; font-weight:bold;"><a href="${ctx}/shinowit/chart?jiage=${prices}&goodsname=${names}&tupianxinxi=${showtupian}">加入购物车</a></span></td>
                            <td align="middle"
                                height="30"><span style="font-size:20px; color:#f00; font-weight:bold;"><a href="${ctx}/shinowit/chart01">点击购买</a></span></td>
                        </tr>
                        </tbody>
                    </table></dd>
                    <br class="spacer" />
